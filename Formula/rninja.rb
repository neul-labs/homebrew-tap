class Rninja < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/neul-labs/rninja/releases/download/v0.1.2/rninja-0.1.2-x86_64-apple-darwin.tar.gz"
      sha256 "ed1e36fa9354a0f05fc6bfc8ce82e8610f5bce58b82210a9d4210d587f73de70"
    end
    on_arm do
      url "https://github.com/neul-labs/rninja/releases/download/v0.1.2/rninja-0.1.2-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/neul-labs/rninja/releases/download/v0.1.2/rninja-0.1.2-x86_64-unknown-linux-gnu.tar.gz"
      sha256 "e526f11ecb43e441818815be481315bf7fd524e46ad14a981fa923c21f9f9444"
    end
    on_arm do
      url "https://github.com/neul-labs/rninja/releases/download/v0.1.2/rninja-0.1.2-aarch64-unknown-linux-gnu.tar.gz"
